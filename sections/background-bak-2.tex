...
\begin{figure}[H]
  ...
  \caption{Overview of Ascend Architecture. The figure illustrates the key components of the Ascend architecture.\scnote{Figure 3 too blurry}}
...
The Ascend~\cite{liao2019davinci} architecture, as illustrated in \autoref{fig:ascend_architecture}, is designed to efficiently handle diverse deep learning workloads by incorporating specialized hardware components. Key components include:
\begin{itemize}
...
\begin{lstlisting}[firstnumber=11, basicstyle=\ttfamily\footnotesize, captionpos=b, frame=single]
...
\end{lstlisting}
\end{minipage}
\caption{Comparison of AoT compilation and JIT compilation for kernel specialization of add operator.}
