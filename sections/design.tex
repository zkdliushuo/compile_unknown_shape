...
\begin{figure}[ht]
  ...
  \begin{minipage}{0.31\textwidth}
    ...
    \begin{minipage}{\linewidth}
        \begin{lstlisting}[language=llvm, basicstyle=\tiny\ttfamily, frame=single, numbers=none, breaklines=true, xleftmargin=1pt, xrightmargin=1pt]
%ret = call @check
%c = icmp ne %ret, 0
br %c, %exit, %nxt
exit: 
...
ret i32 %ret
    ...
    % 右侧整体的 Caption
    \captionof{figure}{Simplified LLVM IR examples of common early return patterns alongside the detection algorithm.}
