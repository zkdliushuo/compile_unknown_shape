...
2) Just-In-Time (JIT)\cite{tillet2019triton,zheng2022dietcode,ansel2024dynamo} determine values of kernel parameters and then compile specialized kernels.
The AoT method usually only specializes a few specific kernel parameters, otherwise it may lead to severe code bloat issues.    
