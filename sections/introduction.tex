...
% 我们在 \autoref{lst:invariable_params_scalar_ratio} 列举了当前面向 Ascend 的 state of the arts 算子库中部分典型算子的性能现状，以及这些算子的参数数目, 评测揭示了当前 Ascend 算子库中存在如下特点：
...
% 此外，我们统计了在特定硬件上部署给定模型时，同一个核函数在处理各种可能形状时的参数中的不变量，我们发现绝大部分参数
