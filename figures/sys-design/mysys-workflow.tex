\begin{figure}[htbp]
    ...
    \Description{Flow diagram showing the workflow from Graph IR through Context Generation, Early-Exit Identification, Constant Propagation, to Kernel Specialization.}
