% Start a paragraph before opening the color group. Otherwise, acmart's
% one-shot no-indent hook is cleared only inside the group and is restored at
% the end of every full-paragraph \red{...}, suppressing later indentation.
\newcommand{\red}[1]{\leavevmode{\color{red}#1}}
\newcommand{\yu}[1] {{\textcolor{OliveGreen}{\textbf{#1}}}}
\newcommand{\yunote}[1] {{$\langle${\red{YU:\textbf{#1}}}$\rangle$}}
...
\newcommand\sxy[1]{{$\langle${\red{SXY:\textbf{#1}}}$\rangle$}}
\newcommand\yzj[1]{{$\langle${\red{YZJ:\textbf{#1}}}$\rangle$}}
\newcommand\scnote[1]{{$\langle${\red{SC:\textbf{#1}}}$\rangle$}}
