...
\multirow{13}{*}{\shortstack{\textbf{LLM}\\\textit{Llama 2}\\\textit{Qwen 2}\\\textit{DeepSeek}}} & \multirow{5}{*}{\shortstack[l]{Prefill Phase\\(Ragged Input)}} & FlashAttention & \textbf{P-Attn} & \texttt{[T, H, D]} & \texttt{Offsets[B+1]} & $T \in [256, 8k]$ \\
\cmidrule{3-7}
...
\cmidrule{3-7}
& & Sinkhorn & \textbf{Sink} & \texttt{[T, E]} & - & $E \in [8, 64]$ \\ % Added Sinkhorn here for Balanced Routing
\cmidrule{3-7}
