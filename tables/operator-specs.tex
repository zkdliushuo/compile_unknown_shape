\begin{table}[t]
    ...
    \textbf{Configurations:} Unless otherwise stated, we fix static dimensions based on representative models: $D=4096, D_{head}=128, N_Q=32, N_{KV}=8, E=8$ for LLM (e.g., Llama-3-8B); $C=512$ for CV (e.g., ResNet-50); and $D=128$ for RecSys.
