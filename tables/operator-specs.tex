\begin{table}[t]
    ...
    \textbf{Symbols:} $T$: Total tokens, $B$: Batch size, $P$: Page size, $N$: Number of Heads ($N_Q$ query, $N_{KV}$ key/value), $D$: Hidden dim (Model dim), $D_{head}$: Head dim ($D/N_Q$), $C$: Channels, $E$: Experts, $H, W$: Image Height/Width. \textbf{Aux. Input}: Geometric parameters.
